...
В этой задаче нужно в каждый день найти репетитора, уроки которого получили самую низкую оценку качества и вывести эту оценку.

Имеются четыре файла с выгрузкой строк из базы.
